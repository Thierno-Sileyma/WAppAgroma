...
namespace WAppAgroma.Controllers
{
    public class FournisseursController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Adresse,Email,Telephone")] Fournisseur fournisseur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Adresse,Email,Telephone")] Fournisseur fournisseur)
        {
