...
namespace WAppAgroma.Controllers
{
    public class ProduitsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Description,Stock,Prix")] Produit produit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Description,Stock,Prix")] Produit produit)
        {
            if (id != produit.Id)
            {
                return NotFound();
