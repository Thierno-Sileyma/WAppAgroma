...
namespace WAppAgroma.Controllers
{
    public class EmployesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Prenom,Poste,Salaire")] Employe employe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Prenom,Poste,Salaire")] Employe employe)
        {
            if (id != employe.Id)
            {
                return NotFound();
