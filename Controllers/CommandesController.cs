...
namespace WAppAgroma.Controllers
{
    public class CommandesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClientId,DateCommande,MontantTotal")] Commande commande)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClientId,DateCommande,MontantTotal")] Commande commande)
        {
            if (id != commande.Id)
            {
                return NotFound();
